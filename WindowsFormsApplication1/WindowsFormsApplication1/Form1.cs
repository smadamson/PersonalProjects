...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void xywh_circle_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            string comment = "";
            if(this.xywh_circle.Checked == true)
            {
                comment += one_xywh_circle_comment;
            }
        ...
        {
            this.comment.Text = "";
            this.xywh_circle.Checked = false;
